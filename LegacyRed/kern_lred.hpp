...
class LRed {
    ...
    GcFwConstant *orgCzRlcUcode = nullptr;
    GcFwConstant *orgCzMeUcode = nullptr;
    GcFwConstant *orgCzCeUcode = nullptr;
    GcFwConstant *orgCzPfpUcode = nullptr;
    GcFwConstant *orgCzMecUcode = nullptr;
