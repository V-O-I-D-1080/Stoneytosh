...
bool X4000::processKext(KernelPatcher &patcher, size_t index, mach_vm_address_t address, size_t size) {
    if (kextRadeonX4000.loadIndex == index) {
        ...
        KernelPatcher::SolveRequest solveRequests[] = {
			...
			{"__ZN31AMDRadeonX4000_AMDCIUVDEngineC1Ev", this->orgGFX7UVDEngineConstructor},
			{"__ZN30AMDRadeonX4000_AMDCISAMUEngineC1Ev", this->orgGFX7SAMUEngineConstructor},
			{"__ZN31AMDRadeonX4000_AMDCIVCEEngineC1Ev", this->orgGFX7VCEEngineConstructor},
			...
			{"__ZN31AMDRadeonX4000_AMDVIUVDEngineC1Ev", this->orgGFX8UVDEngineConstructor},
			{"__ZN30AMDRadeonX4000_AMDVISAMUEngineC1Ev", this->orgGFX8SAMUEngineConstructor},
			{"__ZN31AMDRadeonX4000_AMDVIVCEEngineC1Ev", this->orgGFX8VCEEngineConstructor},
